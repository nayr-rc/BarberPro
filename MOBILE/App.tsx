...
async function registerForPushNotificationsAsync() {
	if (isExpoGo) {
		console.info(
			"Expo Go detectado: notificacoes push remotas foram desativadas neste ambiente.",
		);
		return null;
	}
	...
	try {
		...
		if (!projectId) {
			console.info(
				"Project ID do Expo/EAS nao configurado. Pulando registro de push token.",
			);
			return null;
		}
...
export default function App() {
	const { isHydrated, token, user, hydrate, registerPushToken } =
		useAuthStore();
