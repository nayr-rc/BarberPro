...
export default function BarbeiroClientes() {
    ...
    return (
        <div className="min-h-screen bg-barber-black text-gray-100 flex flex-col font-body p-6">
            <header className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-2xl font-heading text-white tracking-widest uppercase">Meus Clientes</h1>
            </header>

            <main className="flex-1 flex flex-col items-center justify-center text-center space-y-4 opacity-50">
                <Users size={64} className="text-barber-gold mb-2" />
                <h2 className="text-xl font-bold">Base de Dados em Breve</h2>
                <p className="text-sm max-w-xs uppercase tracking-widest">Histórico completo dos seus clientes e preferências de corte.</p>
            </main>
        </div>
    );
}
